...
interface SplashChatProps {
  setOpen: (isOpen: boolean) => void;
}

const SplashChat: React.FC<SplashChatProps> = ({ setOpen }) => {
  return (
    <div className=" max-md:hidden flex flex-col items-center justify-center gap-3 min-h-screen w-full">
      <svg
        aria-label=""
        fill="currentColor"
        height="96"
      ...
      <Button className="mt-4 block" onClick={() => setOpen(true)}>
        {" "}
        Send Message
      </Button>
    </div>
